(function () {
  ...
  const I18N = {
    en: {
      ...
      p1Badge: "Hyper-real",
      p1Title: "Sculpted to read real—from across the room to a curious tap.",
      p1Body:
      ...
      footer: "© HallowCeramics. All hallows reserved.",
      ...
      aboutS2Kicker: "At the bench",
      aboutS2Title: "The hands that earn the double take.",
      aboutS2P:
      ...
      contactInfoKicker: "Studio notes",
      contactInfoTitle: "For orders, wholesale, and custom pieces.",
      contactInfoBody:
      ...
      contactStudioTitle: "Our studio",
      contactStudioAddress: "By appointment for wholesale and custom order previews.",
      contactHoursWeek: "Mon–Thu",
      contactHoursFri: "Friday",
      contactFormKicker: "Send a message",
      contactFormTitle: "Start with a few details.",
      contactNameLabel: "Name",
      contactEmailInputLabel: "Email",
      contactTopicLabel: "What can we help with?",
      contactTopicOrder: "Order question",
      contactTopicWholesale: "Wholesale inquiry",
      contactTopicCustom: "Custom ceramic request",
      ...
      contactCtaKicker: "Wholesale ready",
      contactCtaTitle: "Building a seasonal display?",
      contactCtaText:
    ...
    zh: {
      ...
      p1Badge: "超仿真",
      p1Title: "远看像真南瓜，凑近仍经得起推敲。",
      p1Body:
        "肋纹、瓜蒂与轮廓都由匠人手修完成，保留那种「有点不完美才像活的」质感。高温烧制定型、哑光柔釉，做出让人忍不住伸手确认的那一只——不是模具的平均件，而是经得起端详的超仿真陶瓷南瓜。",
      p1Link: "查看系列 →",
      p2Badge: "搭配",
      ...
      ctaBtn: "登录账户",
      footer: "© HallowCeramics. 万圣保留所有氛围。",
      ...
      aboutS1P3:
        "于是我们走自己的路：HallowCeramics 以团队自有工厂为核心，做你愿意开灯后还愿意摆着的万圣装饰陶瓷。",
      aboutS2Kicker: "工作台畔",
      aboutS2Title: "让「像真」不靠运气，靠一次次的手工较真。",
      aboutS2P:
        "超仿真不是流水线上的一个参数，而是匠人在泥坯前俯身对照光线与比例，一刀一刀修出肋纹与瓜蒂，直到轮廓在日光里也站得住；出窑之后仍会再端详釉面与明暗——我们按「愿意摆在自己客厅里的那一只」来验收。从泥到釉，都有人把这件产品当作自家陈设来较真。你带回家的，正是这种工匠精神里长出来的、经得起凑近看的南瓜。",
      aboutS3Kicker: "我们的理念",
      ...
      aboutCtaBtn: "查看全部产品",
      contactKicker: "联系我们",
      contactTitle: "告诉我们你想做什么。",
      contactIntro:
        "无论是订单问题、批发合作，还是想定制一个更完整的万圣陶瓷角落，都可以留言给我们。我们会像对待每一只手刻南瓜一样认真回复。",
      contactInfoKicker: "工作室信息",
      contactInfoTitle: "订单、批发与定制需求都可以从这里开始。",
      contactInfoBody:
        "告诉我们你正在布置什么：壁炉陈列、零售采购，或是一组为客户空间准备的陶瓷南瓜。",
      contactEmailLabel: "发邮件给我们",
      contactPhoneLabel: "电话联系",
      contactStudioTitle: "我们的工作室",
      contactStudioAddress: "批发与定制样品预览需提前预约。",
      contactHoursWeek: "周一至周四",
      contactHoursFri: "周五",
      contactFormKicker: "发送消息",
      contactFormTitle: "先留下几个细节。",
      contactNameLabel: "姓名",
      contactEmailInputLabel: "邮箱",
      contactTopicLabel: "你想咨询什么？",
      contactTopicOrder: "订单问题",
      contactTopicWholesale: "批发咨询",
      contactTopicCustom: "陶瓷定制需求",
      contactTopicOther: "其他事项",
      contactMessageLabel: "留言",
      contactSubmit: "发送消息",
      contactFormNote:
        "当前表单会打开你的邮件应用。接入 WordPress 或 WooCommerce 后，我们可以把它改成真实的收件箱流程。",
      contactCtaKicker: "支持批发",
      contactCtaTitle: "正在准备季节陈列吗？",
      contactCtaText:
        "把时间、数量和氛围参考发给我们。我们可以帮你搭配适合拍照、也经得起近看的南瓜与陶瓷小物。",
    },
  };

  let lang = localStorage.getItem("hallowceramics-lang") || "en";
  ...
  function toggleLang() {
    lang = lang === "en" ? "zh" : "en";
    localStorage.setItem("hallowceramics-lang", lang);
    applyI18n();
  }
